...
<script>
    // Graph 1: Student Enrollment Trends
    ...
    new Chart(ctx2, {
        ...
        data: {
            ...
            datasets: [{
                label: 'Progress (%)',
                data: [70, 85, 60, 90],
                backgroundColor: ['#6A0DAD', '#FF4500', '#008080', '#FFD700'],
                borderWidth: 1
            }]
        },
        options: {
            ...
            scales: {
                ...
                y: { title: { display: true, text: 'Progress (%)' }, max: 100 }
            }
        }
    });

    // Graph 3: Approval Statistics
    ...
    new Chart(ctx3, {
        ...
        data: {
            ...
            datasets: [{
                label: 'Approvals',
                data: [45, 10, 5],
                backgroundColor: ['#32CD32', '#FFEC8B', '#FF6347']
            }]
        },
        options: {
            responsive: true,
...
<?php 
      if(isset($_GET['submission'])){
            ...
            $sql_query="DELETE FROM `submit_an_article` WHERE `id`='$submission'";
				...
				?>
                  <script>
					...
					toastMixin.fire({
					 ...
					 setTimeout("window.open('index', '_self');", 2000);
				  </script>
				<?php
			}
	  }

				    ...
				    <div class="row">
						<div class="col-xl-12">
							...
							<?php
							 ...
							 $sql_location="SELECT * FROM `Request` ORDER BY `Request`.`Training_date` ASC";
				     ...
				     function status(id){
				           ...
				           $.ajax({
                                ...
                                success: function(data) {
                                      ...
                                      setTimeout(function(){ window.open('request.php','_self'); }, 1500);
            				        ...
            				        $.ajax({
                                            ...
                                            success: function(data) {
                                              ...
                                              if(data == '0'){
                                                  ...
                                                  setTimeout(function(){ window.open('request.php','_self'); }, 2000);
                                              }else{
                                                  var x = document.getElementById("danger");
                                                  x.className = "show";
                                                  setTimeout(function(){ x.className = x.className.replace("show", ""); }, 2000);

...
<?php 
      ...
      if(isset($_POST['submission'])){
            ...
            if($runn == true){
				?>
                  <script>
					...
					toastMixin.fire({
					 ...
					 setTimeout("window.open('ds_project_qc_status.php', '_self');", 2000);
				  </script>
				<?php
			}
			    ...
			    <script>
			    alert("failed");
			    setTimeout("window.open('ds_project_qc_status.php', '_self');", 1000);
				     ...
				     function status(id){
				           ...
				           $.ajax({
                                ...
                                success: function(data) {
                                      ...
                                      setTimeout(function(){ window.open('ds_project_qc_status.php','_self'); }, 1500);
        				        ...
        				        $.ajax({
                                        ...
                                        success: function(data) {
                                          ...
                                          if(data == '0'){
                                              ...
                                              setTimeout(function(){ window.open('ds_project_qc_status.php','_self'); }, 2000);
                                          }else{
                                              var x = document.getElementById("danger");
                                              x.className = "show";
                                              setTimeout(function(){ x.className = x.className.replace("show", ""); }, 2000);

...
<body>
            ...
            <div class="content-inner">
                ...
                <div class="page-header page-header-light shadow">
                    <div class="page-header-content d-lg-flex align-items-center justify-content-between">
                        <h4 class="page-title mb-0 text-primary fw-bold">
                            <i class="fas fa-undo-alt"></i> Restore Deleted Projects
                        </h4>
                    </div>
                </div>
                ...
                <div class="content">
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <?php
                            $sql = "SELECT * FROM `dump_add_project` ORDER BY `date` DESC";
                            $result = mysqli_query($conn, $sql);
                            if (mysqli_num_rows($result) > 0) {
                            ?>
                                <table id="restoreTable" class="table table-striped table-hover">
                                            ...
                                            <tr id="row_<?php echo $data['id']; ?>">
                                                ...
                                                <td>
                                                    <button id="restore-btn-<?php echo $data['id']; ?>" 
                                                            ...
                                                            onclick="restoreProject(<?php echo $data['id']; ?>)">
                            ...
                            <?php
                                ...
                                echo "<div class='alert alert-info text-center'><strong>No deleted projects found.</strong></div>";
                            }
                            ?>
                        </div>
                    </div>
    ...
    <script>
        ...
        function restoreProject(id) {
            ...
            $.ajax({
                type: "POST",
                url: "Restore/restore_projects.php",
                data: { id: id },
                dataType: "json",

				...
				?>
                  <script>
					...
					toastMixin.fire({
					 ...
					 setTimeout("window.open('cs_training_q.php', '_self');", 2000);
				  </script>
				<?php
			}
	  }
	...
	<div class="page-content">
		...
		<div class="content-wrapper">
			...
			<div class="content-inner">
						...
						<div class="d-flex">
							<h4 style="font-size: 18px;" class="page-title mb-0">
								<span style="font-size: 16px;" class="fw-normal">
								    <!--uncomment to enable addition of training Queue-->
				...
				<form method="POST" action="cs_training_q.php">
                              ...
                              while($data=mysqli_fetch_assoc($runn)){
                                  ?>
                                        <tr id="del_<?php echo $data['id']; ?>"> 
                                            ...
                                            ?>
                                            <!--comment to enable delete feature-->
                                            <th> 
                                            <a>Action Disabled</a>
				     ...
				     function status(id){
				           ...
				           $.ajax({
                                ...
                                success: function(data) {
                                      ...
                                      setTimeout(function(){ window.open('cs_training_q.php','_self'); }, 1500);
        				        ...
        				        $.ajax({
                                        ...
                                        success: function(data) {
                                          ...
                                          if(data == '0'){
                                              ...
                                              setTimeout(function(){ window.open('cs_training_q.php','_self'); }, 2000);
                                          }else{
                                              var x = document.getElementById("danger");
                                              x.className = "show";
                                              setTimeout(function(){ x.className = x.className.replace("show", ""); }, 2000);

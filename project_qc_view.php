...
if (isset($_GET['export_excel'])) {
    ...
    LEFT JOIN project_qc_status pqc ON p.id = pqc.project_id
    ...
    $columns = ["Sr. No", "Project Id", "Project Name", "Cluster", "QC Name", "Precision", "Recall", "Status","URL","Date","Taggers"];
                ...
                foreach ($projects as $project) {
                    ...
                    foreach ($qc_headers as $qc_id => $qc_name) {
                        ...
                        echo "<td>
                                ...
                                R: {$recall}%<br>
                                Taggers: {$taggers}<br>
                                <a href='{$url}' target='_blank'>View Details</a><br>
                                {$date}
                            </td>";
                    }
